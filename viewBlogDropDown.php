...
<head>
<meta charset="utf-8">
<title>Keshav Bokhoree - Blog</title>
...
<body>
	...
	<header>
			...
			<?php
				...
				if ($_SESSION["user"] == ""){	
				echo '<a id="login_btn" href="login.html">LOGIN</a>';
				}
				else {
				echo '<p id="welcomeMsg">Welcome back,'.$_SESSION["user"].' </p>';
				echo '<a href="logout.php" id="signout" >Sign out</a>';	
				}
		...
		<section class="main">
			<a href="addPost.html" id="addPostBtn" >Add Post</a>
